        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ Request::is('propiedades') ? 'active' : '' }}"><a href="/propiedades"
                            class="{{ Request::is('propiedades') ? 'active' : '' }}">Propiedades</a></li>
                    @if (isset($location['id']))
                        <li class="breadcrumb-item active" aria-current="page"><a
                                href='/propiedades?location={{ $location['id'] }}'
                                class="active">{{ $location['name'] }}</a></li>
                    @endif
                </ol>
            </nav>
            @if (!$searchmode)
                        ...
                        <div class="inline">
                            @foreach ($ubicaciones as $key => $u)
                                <a class="btn btn-outline-secondary"
                                    href="/propiedades?order=minprice&location={{ $u['id'] }}">
            ...
            <div class="row">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        @if ($searchmode)
                            <a id="toggleFilters" href="javascript:void(0)" class="text-primary d-none d-md-block">Filtro <i
                                    class="bi bi-filter"></i> </a>
                            <a id="toggleFiltersMobile" href="javascript:void(0)" class="text-primary d-md-none"
                                data-bs-toggle="modal" data-bs-target="#staticBackdrop">Filtro <i class="bi bi-filter"></i>
                            </a>
                        @endif
                    </div>
                    <div class="col-6 text-end">
                        Ordenar por:
                        <div class="btn-group">
                            <a class="dropdown-toggle dd-order" type="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:void(0)" id="orderBy1">Mas relevantes</a>
                                </li>
                    ...
                    <div class="col-3 d-none d-md-block " id="filter">
                        <div class="row ">
                            <fieldset class="col-12 my-2 p-3">
                                ...
                                <form action="/propiedades" id="filterForm">
                                    <input type="hidden" id="location" name="location" value="{{ $locationQP }}"
                                        id="locationInput">
                                    <input type="hidden" name="order" value="{{ $orderQP }}" id="orderBy">
                                    <div class="row">
                                        <div class="col-12 text-primary mb-3">
                                            ...
                                            <div class="dropdown">
                                                <button class="form-control dd-select text-start" type="button"
                                                ...
                                                <ul class="dropdown-menu full">
                                                    @foreach ($ubicaciones as $key => $u)
                                                        <li><a class="dropdown-item" href="javascript:void(0)"
                                                                onclick="submitLocation('{{ $u['id'] }}')"><i
                                                                    class="bi bi-geo-alt text-primary"></i>
                                                                {{ $u['name'] }}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <input type="checkbox" name="allTypes" id="chk_1" value="all"
                                                        {{ $allTypesQP == 'all' ? 'checked' : '' }}><label class="fc-text"
                                                        for="chk_1">Todos</label>
                                                </div>
                                                @foreach ($typesProperties as $key => $tp)
                                                    <div class="col-6">
                                                        <input id="chktp_{{ $tp['id'] }}"
                                                            class="chk_action chk_types" type="checkbox" name="type[]"
                                                            value="{{ $tp['id'] }}"
                                                            {{ is_array($typeQP) && in_array($tp['id'], $typeQP) ? 'checked' : '' }}>
                                                        <label class="fc-text"
                                                            for="chktp_{{ $tp['id'] }}">{{ $tp['name'] }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label>Desde</label>
                                                    <label class="form-control" id="budg1" name="budg1"
                                                        data-type="currency">{{ $budg1 }}</label>
                                                </div>
                                                <div class="col-6">
                                                    <label>Hasta</label>
                                                    <label class="form-control" id="budg2" name="budg2"
                                                        data-type="currency">{{ $budg2 }}</label>
                                                </div>
                                                <div class="col-12 mt-4 pe-4">
                                                    <input type="hidden" class="form-range" id="budget"
                                        ...
                                        <div class="col-6 text-primary mb-3">
                                            ...
                                            <select class="form-control select_actions" name="rooms">
                                                <option value="" {{ $roomsQP == '' ? 'selected' : '' }}>Seleccione
                                                </option>
                                                ...
                                                <option value="10" {{ $roomsQP == '10' ? 'selected' : '' }}>10
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-6 text-primary mb-3">
                                            ...
                                            <select class="form-control select_actions" name="bathrooms">
                                                <option value="" {{ $bathroomsQP == '' ? 'selected' : '' }}>
                                                    Seleccione</option>
                                                <option value="1" {{ $bathroomsQP == '1' ? 'selected' : '' }}>1
                                                </option>
                                                <option value="2" {{ $bathroomsQP == '2' ? 'selected' : '' }}>2
                                                </option>
                                                <option value="3" {{ $bathroomsQP == '3' ? 'selected' : '' }}>3
                                                </option>
                                                <option value="4" {{ $bathroomsQP == '4' ? 'selected' : '' }}>4
                                                </option>
                                                <option value="5" {{ $bathroomsQP == '5' ? 'selected' : '' }}>5
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-12 text-primary mb-3">
                                            ...
                                            <select class="form-control select_actions" name="parking">
                                                <option value="" {{ $parkingQP == '' ? 'selected' : '' }}>Seleccione
                                                </option>
                                                <option value="1" {{ $parkingQP == '1' ? 'selected' : '' }}>1 auto
                                                </option>
                                                <option value="2" {{ $parkingQP == '2' ? 'selected' : '' }}>2 autos
                                                </option>
                                                <option value="3" {{ $parkingQP == '3' ? 'selected' : '' }}>3 autos
                                                </option>
                                                <option value="4" {{ $parkingQP == '4' ? 'selected' : '' }}>4 autos
                                                </option>
                                                <option value="5" {{ $parkingQP == '5' ? 'selected' : '' }}>5 autos
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-12 text-primary mb-3">
                                            <div class="row">
                                                ...
                                                @foreach ($conditionsProperty as $key => $cp)
                                                    <div class="col-6">
                                                        <input class="chk_action" type="checkbox" name="condition[]"
                                                            value="{{ $cp['id'] }}" id="chkcp_{{ $cp['id'] }}"
                                                            {{ is_array($conditionsQp) && in_array($cp['id'], $conditionsQp) ? 'checked' : '' }}>
                                                        <label class="fc-text"
                                                            for="chkcp_{{ $cp['id'] }}">{{ $cp['name'] }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                            ...
                                            <div class="container-amenities">
                                                @foreach ($amenities as $key => $a)
                                                    <div class="item">
                                                        <div class="d-flex">
                                                            <div class="me-2">
                                                                <input class="chk_action" type="checkbox"
                                                                    name="amenities[]" value="{{ $a['id'] }}"
                                                                    id="chka_{{ $a['id'] }}"
                                                                    {{ is_array($amenitiesQp) && in_array($a['id'], $amenitiesQp) ? 'checked' : '' }}>
                                                            </div>
                                                            <div>
                                                                <label class="fc-text"
                                                                    for="chka_{{ $a['id'] }}">{{ $a['name'] }}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                ...
                <div id="contentWrapper"
                    class="col-12 @if ($searchmode) col-md-9 @else col-md-12 @endif ">
                    <div class="row">
                        @foreach ($results as $index => $card)
                            <div
                                class="results-items col-12 @if ($searchmode) col-md-6 @else col-md-4 @endif d-flex justify-content-center mb-4">
                                <x-card :card="$card" />
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="container py-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 order-1 order-md-2 mt-4 ">
                        ...
                        <p>En Terrazon, nos especializamos en ofrecer las mejores propiedades inmobiliarias adaptadas a
                            todos los gustos y necesidades. Nuestro equipo de expertos se dedica a encontrar el hogar
                            perfecto para cada cliente, proporcionando un servicio personalizado y profesional en cada etapa
                            del proceso. Ya sea que busques una casa familiar, un apartamento moderno o una villa de lujo
                            frente al mar, en Terrazon tenemos la opción ideal para ti. Descubre la diferencia de comprar
                            con nosotros y encuentra no solo una propiedad, sino un lugar donde tus sueños pueden hacerse
                            realidad.</p>
                        <p class="d-none d-md-block">
                            <a href="{{ url('/contacto') }}" class="text-center">
                    ...
                    <div class="col-6 col-md-3 offset-md-6 order-3 order-md-3">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="subtitle text-secondary fw-400  text-nowrap text-clientes">clientes Satisfechos
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 order-3 order-md-3">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="subtitle text-secondary fw-400  text-nowrap text-clientes">Propiedades
                                    verificadas</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container py-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-4  px-md-5">
                        ...
                        <div class="description text-center">Ofrecemos ayuda legal experta para todos los artículos
                            inmobiliarios relacionados.</div>
                    </div>
                    <div class="col-12 col-md-4 mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="row">
                                            ...
                                            @foreach ($typesProperties as $key => $tp)
                                                <div class="col-6">
                                                    <input id="chktp_{{ $tp['id'] }}" class="chk_action chk_types"
                                                        type="checkbox" name="type[]" value="{{ $tp['id'] }}"
                                                        {{ is_array($typeQP) && in_array($tp['id'], $typeQP) ? 'checked' : '' }}>
                                                    <label class="fc-text"
                                                        for="chktp_{{ $tp['id'] }}">{{ $tp['name'] }}</label>
                                                </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <label>Desde</label>
                                                <label class="form-control" id="mbudg1" name="budg1"
                                                    data-type="currency">{{ $budg1 }}</label>
                                            </div>
                                            <div class="col-6">
                                                <label>Hasta</label>
                                                <label class="form-control" id="mbudg2" name="budg2"
                                                    data-type="currency">{{ $budg2 }}</label>
                                            </div>
                                            <div class="col-12 mt-4 pe-4">
                                                <input type="hidden" class="form-range" id="mbudget" name="budget"
                                                    value="{{ $budget }}">
                                    ...
                                    <div class="col-6 text-primary mb-3">
                                        <label>Baños completos</label>
                                        <select class="form-control select_actions" name="bathrooms">
                                            <option value="" {{ $bathroomsQP == '' ? 'selected' : '' }}>Seleccione
                                            </option>
