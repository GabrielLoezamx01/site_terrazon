              ...
              <div class="d-flex"
                  ...
                  <ul class="navbar-nav flex-row" style="gap: 1rem; white-space: nowrap; padding: 0; margin: 0;">
                      <li class="nav-item" style="scroll-snap-align: start">
                          <a class="nav-link active" href="{{ url('/custom/home') }}">Perfil</a>
                      </li>
                      <li class="nav-item" style="scroll-snap-align: start">
                      ...
                      <li class="nav-item" style="scroll-snap-align: start">
                          <a class="nav-link" href="{{ url('custom/favorite') }}">Favoritos</a>
                      </li>
                      <li class="nav-item" style="scroll-snap-align: start">
                          <a class="nav-link" href="#">Comunicación</a>
                      </li>
                      <li class="nav-item" style="scroll-snap-align: start">
                          <a class="nav-link" href="{{ url('custom/privacy') }}">Aviso de Privacidad</a>
                      </li>
                      <li class="nav-item" style="scroll-snap-align: start">
