                ...
                <div class="modal-body">
                        ...
                        <input type="text" class="form-control" required placeholder="Nombre" v-model="input.name">
                         ...
                         <div class="mb-3 text-center p-4">
                            <button class="btn btn-primary"  @click="updateData">OK</button>
                        </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <button class="btn btn-dark" @click="showModal(false)">
                            ...
                            <tbody>
                                @foreach ($home as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success btn-icon btn-sm" title="Añadir Propiedades">
                                              ...
                                              <button @click="showHome('{{ $item['id'] }}')" class="btn btn-info btn-icon btn-sm" title="Editar Contenido">
