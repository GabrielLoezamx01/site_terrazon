        ...
        <div class="row  row-cards  card p-5">
            ...
            <div class="row">
                <form action="{{ route('property.update', ['property' => $property['folio']]) }}" method="POST"
                    ...
                    <div class="mb-3">
                        <label class="form-label required">Código de YouTube</label>
                        <textarea name="video" id="" cols="30" rows="5" class="form-control"> {{ $property['video'] }}</textarea>
                        {{-- <input type="text" name="video" value="{{ $property['video'] }}" class="form-control"> --}}
                    </div>
                    <div class="mb-3">
                        <label class="form-label required">Código de tour virtual</label>
                        <textarea name="tour" id="" cols="30" rows="5" class="form-control">{{ $property['tour'] }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="">M2</label>
